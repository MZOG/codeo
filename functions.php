...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.3'); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('codeo', get_template_directory_uri() . '/codeo.min.css', array(), '2.1.0', 'all');
